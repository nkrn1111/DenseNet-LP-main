...
def runPreProcess(graph_file_name,gui):
    try:
        ...
        list_output.insert(0,"Loading graph from file: "+ graph_file_name)
        ...
        print(string_to_print)
        list_output.insert(1,string_to_print)
        ...
        string_to_print="Training Set Graph after deleting"+ str(percentage_of_edges_to_remove)+ "% of the edges "+str(nx.info(training_set_graph))
        print(string_to_print)
        list_output.insert(2, string_to_print)
        ...
        string_to_print="Test Set Graph with the deleted"+ str(percentage_of_edges_to_remove)+ "% edges and addition of"+str((percentage_of_negative_class_additions - percentage_of_edges_to_remove))+ "% random negative class edges"+str(nx.info(test_set_graph))
        print(string_to_print)
        list_output.insert(3, string_to_print)
